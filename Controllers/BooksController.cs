...
namespace Ilie_Adrian_Laurentiu_Lab2.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            switch (sortOrder)
            {
                case "title_desc": books = books.OrderByDescending(b => b.Title); break;
            ...
            int pageSize = 2;
            return View(await PaginatedList<Book>.CreateAsync(books.AsNoTracking().Include(x => x.Author), pageNumber ?? 1, pageSize));
        }
        ...
        public async Task<IActionResult> Delete(int? id, bool? saveChangesError = false)
        {
            ...
            if (saveChangesError.GetValueOrDefault()) { ViewData["ErrorMessage"] = "Delete failed. Try again"; }
        ...
        {
            var book = await _context.Books.FindAsync(id); if (book == null) { return RedirectToAction(nameof(Index)); }
            try
            {
